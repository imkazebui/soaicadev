...
$link_color       = get_theme_mod( 'color_primary', '#fd79a8' );
$color_primary    = get_theme_mod( 'color_primary', '#fd79a8' );
...
$border_radius    = get_theme_mod( 'design_border_radius', '30px' );
...
.amp-wp-enforced-sizes {
	/** Our sizes fallback is 100vw, and we have a padding on the container; the max-width here prevents the element from squaretypeing. **/
	max-width: 100%;
	margin: 0 auto;
}
...
.amp-wp-header .navbar-content {
	...
	align-items: center;
	position: relative;
	height: <?php echo esc_attr( get_theme_mod( 'header_nav_height', '60px' ) ); ?>;
}
